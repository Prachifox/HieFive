...
<p><a href='logout.php' style='color:teal'><h6><i class='fa fa-mouse-pointer'></i> Logout</h6></a></p>
<br>
<br></div>
";
 ?>
...
<center><h4><span class='teal-text'>Find</span> New People</h4></center>
<div class='row'>
  <div class='col s12 m4 offset-m9'>
    <form method='get'> 
    <input type="text" name="search_user" placeholder="Search Friend">
    <button class='btn' type="submit" name="search_user_button">Search</button>
     </form>
  </div>
</div>
<?php search_user();?>
